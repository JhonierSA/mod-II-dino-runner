...
HEARTS = [
    pygame.image.load(os.path.join(IMG_DIR, "Other/Heart1.png")),
    pygame.image.load(os.path.join(IMG_DIR, "Other/Heart2.png")),
    pygame.image.load(os.path.join(IMG_DIR, "Other/Heart3.png")),
]
